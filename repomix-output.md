...
prisma/
  migrations/
    20260108144805_reinit_schema/
      migration.sql
    20260117025613_fix_auth_tables/
      migration.sql
    migration_lock.toml
  schema.prisma
  seed.ts
...
## File: src/modules/profile/dto/profile.dto.ts
````typescript
...
## File: prisma/migrations/20260117025613_fix_auth_tables/migration.sql
````sql
/*
  Warnings:
...
## File: src/decorators/session.decorator.ts
````typescript
...
## File: src/modules/daily/daily.module.ts
````typescript
import { Module } from '@nestjs/common';
...
## File: src/modules/exam/interfaces.ts
````typescript
...
## File: src/modules/daily/dto/daily.dto.ts
````typescript
...
## File: src/modules/daily/daily.controller.ts
````typescript
...
SMTP_SECURE=false
SMTP_FROM="Jitu Team <no-reply@jitu.com>"
````

## File: src/modules/daily/daily.service.ts
````typescript
...
````json
{
  ...
  "dependencies": {
    ...
    "@prisma/adapter-pg": "^7.1.0",
    "@prisma/client": "^7.1.0",
    "@thallesp/nestjs-better-auth": "^2.2.2",
    "bcryptjs": "^3.0.3",
    "better-auth": "^1.4.5",
    "class-transformer": "^0.5.1",
    "class-validator": "^0.14.3",
